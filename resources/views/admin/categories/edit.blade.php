...
@section('header-content')
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edición de la Categoría {{ $category->name }}</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                      ...
                      <div class="card-body">
                       ...
                       @include('admin.includes.errors')
                        ...
                        <div class="form-group">
                          ...
                          <input required type="text" class="form-control" id="name" name="name" placeholder="Ingrese nombre de la categoría" value="{{ old('name', $category->name) }}">
                        ...
                        <div class="form-group">
                          ...
                          <textarea class="form-control" id="description" name="description" rows="2" placeholder="Ingrese una descripción de la categoría.">{{ old('description', $category->description) }}</textarea>
                          <div class="invalid-feedback">
